@echo off
title DBDAudioRenamer v0.3.0 (PAK, BNK, XML files by Neinndall)
color b
:MENU_START
cls
...
pause>nul
FOR /F %%B IN ("%DIR_WEM%\*.XML") DO ("Tools\quickbms.exe" "Tools\scripts\New_parse.bms" %%B Files\WEM\Output)
echo :::  _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____
echo :::  
echo :::  The Audio Files was renamed in Files/WEM/renamed. Press a key for continue...
echo :::  _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____
pause>nul
...
echo :::  _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____
echo :::  
echo :::  The XML was moved to %DIR_WEM% folder. Press a key for continue...
echo :::  _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____ _____
pause>nul
